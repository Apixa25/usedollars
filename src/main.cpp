...
uint256 hashGenesisBlock("0x6eed96dd3a3a043048e0bd2108ff01f716221d4ecde85e0d495beed5fc8dbb58");
...
const string strMessageMagic = "useDollars Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // useDollars: 1 days
static const int64 nTargetSpacing = 120; // useDollars: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal usedollars miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "useDollars", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xca4400cfad8cb07a2b2f698f3d6c337509efc815c20f761472a1b0653c7d2c63");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "January 24th Steve Lunnetta Was in Crescent City CA";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1390605435; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 298106;

        if (fTestNet)
        {
            block.nTime    = 1390601333;
            block.nNonce   = 992907;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xfc5a028cf5aa5df014d6fe563935a3fc88d4289d8fdb3e4d272621c8772c6857"));
